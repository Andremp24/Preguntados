...
public class Ronda_Tres {
    ...
    public void rondatres() {
        ...
        switch (opcion) {
            case 1:
                System.out.println("Esta pregunta es por : $3 punto ");
                System.out.println(" ");
                System.out.println(p1.condicion[0][2]);
                do {
                ...
                if (elegir == 4) {
                    ...
                    System.out.println(" ");
                    JOptionPane.showMessageDialog(null, "FELICIDADES ACABA DE GANAR $3");
                    System.out.println(" ");
                    u.setScore(3);
                    System.out.println("su puntaje actual es $" + u.getScore());
                    System.out.println(" ");
                    System.out.println("Seguir avanzando por : $4");
                    System.out.println(" ");
                ...
                break;
            case 2:
                System.out.println("Esta pregunta es por  : $3 puntos");
                System.out.println(" ");
                System.out.println(p1.condicion[1][2]);
                do {
                    elegir = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su opcion"));
                } while (elegir > 4 || elegir < 1);
                ...
                break;
            case 3:
                System.out.println("Esta pregunta es por un punto : $3 puntos");
                System.out.println(" ");
                System.out.println(p1.condicion[2][2]);
                do {
                    elegir = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su opcion"));
                } while (elegir > 4 || elegir < 1);
            ...
            case 4:
                System.out.println("Esta pregunta es por : $3 puntos ");
                System.out.println(" ");
                System.out.println(p1.condicion[3][2]);
                do {
                    elegir = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su opcion"));
                } while (elegir > 4 || elegir < 1);
            ...
            case 5:
                System.out.println("Esta pregunta es por : $3 puntos ");
                System.out.println(" ");
                System.out.println(p1.condicion[4][2]);
                do {
                    elegir = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su opcion"));
                } while (elegir > 4 || elegir < 1);
